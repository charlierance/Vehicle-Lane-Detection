...
class CalibrateCamera:
    ...
    def undistort_image(self, camera_matrix, distortion_coefficients, save_image=False):
        """
        ...
        """
        image = cv2.imread(self.distorted_image)
        dst = cv2.undistort(image, camera_matrix, distortion_coefficients, None, camera_matrix)
        ...
        if save_image:
            ...
            plt.savefig("../../output_images/calibration/calibrated_and_undistorted_image.jpg")
